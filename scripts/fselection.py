...
datalabel = df.ix[:,1].unique().astype(str)
...
for algos in  dimred_algorithms:
    ...
    plots = vdata.visualizedata(t2_data,dimred_method2,colmap='Accent',collabel=datalabel)
    plots2 = vdata.visualizedata3d(t_data, dimred_method,colmap='Accent',collabel=datalabel)
