...
folder_to_write = "D:\\lcif\\16032017-IndividualFiles\\TrainTestdataset\\adaboost\\kneighbors\\"
...
adaboost = AdaBoostClassifier(base_estimator=kneighbors,n_estimators=50)
...
for k,i in enumerate(sampling_methods):
    ...
    for j in sample_sizes:
        train, test, time = lfs.learn_from_sample(train_data, train_target,
                                            ...
                                            i, adaboost,data_scaler,False,5)
