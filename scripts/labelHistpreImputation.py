# -*- coding: utf-8 -*-
"""
Created on Mon Mar 27 16:09:17 2017
...
label_list = sorted(rdf['app_class_label']
           .drop_duplicates().dropna()
           .values.astype('U'))   
           
appDataSet = []
           
for app in label_list:
    adf = rdf.loc[rdf['app_class_label']==app]
...
for ds in appDataSet:
   ...
   plt.savefig("D:\\lcif\\Histogram\\Label\\NoiseLevel\\"+appName+".png")
   plt.close()
   ########################################################################
   ...
   plt.xlabel('Latitude')
   plt.ylabel('Frequency')
   plt.savefig("D:\\lcif\\Histogram\\Label\\Latitude\\"+appName+".png")
   plt.close()
   ########################################################################   
   ...
   plt.ylabel('Frequency')
   plt.savefig("D:\\lcif\\Histogram\\Label\\Longitude\\"+appName+".png")
   plt.close()
   ########################################################################   
   ...
   plt.xlabel('Level')
   plt.ylabel('Frequency')
   plt.savefig("D:\\lcif\\Histogram\\Label\\Level\\"+appName+".png")
   plt.close()
   ########################################################################   
   ...
   plt.ylabel('Frequency')
   plt.savefig("D:\\lcif\\Histogram\\Label\\Temperature\\"+appName+".png")
   plt.close()
   ########################################################################   
